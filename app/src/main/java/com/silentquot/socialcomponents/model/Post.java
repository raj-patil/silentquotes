...
public class Post extends FollowingPost implements Serializable, LazyLoading {
    ...
    public Map<String, Object> toMap() {
        ...
        result.put("collabPostId",collabPostId);
    ...
    public String getCollabPostId() {
        return collabPostId;
    }


    public void setCollabPostId(String collabPostId) {
        this.collabPostId = collabPostId;
    }
