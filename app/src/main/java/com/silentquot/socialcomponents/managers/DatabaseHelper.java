...
public class DatabaseHelper {
    ...
    public static final String UPLOAD_CHAT_IMAGES_STORAGE_KEY = "uploadedChatImages";
    public static final String UPLOAD_CHAT_IMAGES_THUMBNAIL_STORAGE_KEY = "thumbnail";
    public static final String IMAGES_MEDIUM_KEY = "medium";
    public static final String IMAGES_SMALL_KEY = "small";
    public static final String POST_BOOKMARK_DB_KEY="bookmark";
    public static final String REQUEST_DB_KEY="friend_req";
    public static final String CONNECTION_DB_KEY="friends";
    public static final String CHATLIST_DB_KEY="Chatlist";
    public static final String MESSAGES_DB_KEY="Chats";
    public static final String BRODCAST_DB_KEY="Brodcast";
    public static final String BRODCAST_CHATS_DB_KEY="BrodcastChats";
    public static final String BRODCAST_USER_LIST_DB_KEY="Brodcastlist";
...
//        Sets the maximum time to retry upload operations if a failure occurs.
    ...
    public UploadTask uploadChatImage(Uri uri, String imageTitle) {
        StorageReference riversRef = getStorageReference().child(UPLOAD_CHAT_IMAGES_STORAGE_KEY + "/" + imageTitle);
    ...
    public UploadTask uploadChatImageThumbnail(Uri uri, String imageTitle) {
        StorageReference riversRef = getStorageReference().child(UPLOAD_CHAT_IMAGES_STORAGE_KEY + "/" + UPLOAD_CHAT_IMAGES_THUMBNAIL_STORAGE_KEY +"/"+ imageTitle);
