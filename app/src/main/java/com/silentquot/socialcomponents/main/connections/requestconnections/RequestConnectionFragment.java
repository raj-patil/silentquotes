...
public class RequestConnectionFragment extends BaseFragment<RequestConnectionView, RequestConnectionPresenter>
        implements RequestConnectionView, Searchable {
    ...
    @NonNull
    @Override
    public RequestConnectionPresenter createPresenter() {
        if (presenter == null) {
            return new RequestConnectionPresenter(getActivity());
        }
        return presenter;
    }
