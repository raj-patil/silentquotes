...
package com.silentquot.socialcomponents.main.usersList;
...
import com.silentquot.socialcomponents.adapters.UsersAdapter;
import com.silentquot.socialcomponents.adapters.holders.UserViewHolder;
...
public class UsersListActivity extends BaseActivity<UsersListView, UsersListPresenter> implements UsersListView {
    ...
    public static final int UPDATE_CONNECT_STATE_REQ = 1601;
    public static final int UPDATE_CONNECT_STATE_RESULT_OK = 1602;
