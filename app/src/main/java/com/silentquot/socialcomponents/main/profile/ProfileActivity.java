...
public class ProfileActivity extends BaseActivity<ProfileView, ProfilePresenter> implements ProfileView, GoogleApiClient.OnConnectionFailedListener, UnfollowConfirmationDialog.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter.checkConnectState(userID);
    ...
    private void initListeners() {
        ...
        cancelButton.setOnClickListener( v -> {
            presenter.onCancelConnectionButtonClick(connectButton.getState() , userID);
        });

        connectButton.setOnClickListener(v -> {
            presenter.onConnectButtonClick(connectButton.getState(), userID);
        });
...
//    }
    ...
    @Override
    public void updateConnectButtonState(ConnectionState connectionState){
        if (connectionState==ConnectionState.USER_SEND_CONNECT_REQUEST_TO_ME)
        {
            ...
            cancelButton.setBackground(ContextCompat.getDrawable(getApplicationContext(), R.drawable.follow_button_dark_bg));
            cancelButton.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.white));
        }
        if (connectionState==ConnectionState.CONNECTED_EACH_OTHER){
            ...
            messageButton.setBackground(ContextCompat.getDrawable(getApplicationContext(), R.drawable.follow_button_light_bg));
            messageButton.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.primary_dark_text));
        }
        connectButton.setState(connectionState);
    ...
    @Override
    public void setConnectStateChangeResultOk() {
        setResult(UsersListActivity.UPDATE_FOLLOWING_STATE_RESULT_OK);
    }
