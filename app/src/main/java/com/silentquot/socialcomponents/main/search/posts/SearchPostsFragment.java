...
import com.silentquot.socialcomponents.adapters.SearchPostsAdapter;
...
public class SearchPostsFragment extends BaseFragment<SearchPostsView, SearchPostsPresenter>
    ...
    private void initRecyclerView() {
        ...
        postsAdapter.setCallBack(new SearchPostsAdapter.CallBack() {
            ...
            public void onItemClick(Post post, View view) {
                PostManager.getInstance(getActivity().getApplicationContext()).isPostExistSingleValue(post.getId(), new OnObjectExistListener<Post>() {
                    ...
                    public void onDataChanged(boolean exist) {
                        if (exist) {
                            openPostDetailsActivity(post.getId(), view);
                        } else {
            ...
            @Override
            public void onCollabAutherClick(String collabPostId, View v) {
                PostManager postManager=PostManager.getInstance(getContext());
                postManager.getSinglePostValue(collabPostId, new OnPostChangedListener() {
                    @Override
                    public void onObjectChanged(Post obj) {
                        openProfileActivity(obj.getAuthorId(), v);
                    }
