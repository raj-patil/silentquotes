...
import com.silentquot.socialcomponents.adapters.PostsAdapter;
...
public  class MainActivity extends BaseActivity<MainView, MainPresenter> implements MainView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_social_components);
    ...
    private void initPostListRecyclerView() {
        ...
        postsAdapter.setCallback(new PostsAdapter.Callback() {
            ...
            @Override
            public void onCollabContainerClick(Post itemByPosition, View view) {
