...
package com.silentquot.socialcomponents.main.base;
...
public abstract class BaseActivity<V extends BaseView, P extends BasePresenter<V>> extends MvpActivity<V, P> implements BaseView {
    ...
    public void startLoginActivity() {
        Intent intent = new Intent(this, VerificationPhoneActivity.class);
    ...
    public  boolean checkWriteExternalPermission(Context context){
     return  presenter.checkWriteExternalPermission(context);
    }
