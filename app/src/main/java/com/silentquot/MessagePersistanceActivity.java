...
import com.silentquot.Fragments.NetworkUtil;
...
import com.silentquot.dommain.Conversation;
import com.silentquot.dommain.Message;
...
public class MessagePersistanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // and this
                startActivity(new Intent(MessagePersistanceActivity.this, MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });
...
Toast.makeText(this , chat_key , Toast.LENGTH_LONG).show();
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!msg.equals("") && msgtype != "Image") {
                    ...
                    Toast.makeText(MessagePersistanceActivity.this, "post Uploading...", Toast.LENGTH_SHORT).show();
                    uploadImage();

                } else {
                    Toast.makeText(MessagePersistanceActivity.this, "You can't send empty message", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
        ...
        if (("userchat").equals(chatType)) {
            String status = NetworkUtil.getConnectivityStatusString(MessagePersistanceActivity.this);
            if(status==null) {
                username.setText(userName);
                readMesagges(fuser.getUid(), userid, "default", chatType);
            }
...
//            messageActivity_txt_box.setEnabled(false);
            ...
            uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(MessagePersistanceActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                    }
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(MessagePersistanceActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            Toast.makeText(MessagePersistanceActivity.this, "No image selected", Toast.LENGTH_SHORT).show();
            msgtype="Text";
        }
    }
    ...
    private void sendMessage(String sender, final String receiver, String message, String msgtype, final String chatType) {
        ...
        if (("userchat").equals(chatType)) {
            Chat Message = new Chat(fuser.getUid(),userid , message , true, msgtype );
            mchat.add(Message);
...
//                chatRefReceiver.child("timestamp").setValue( ServerValue.TIMESTAMP);
                                ...
                                Toast.makeText(MessagePersistanceActivity.this , "Sorry !  You can't Send message to This person  , Send a request To Start Communication"  , Toast.LENGTH_LONG);
                            }
                        }
...
//
            ...
            if ( isadmin){
                ...
                Toast.makeText(MessagePersistanceActivity.this, "Sorry You Can Not Send Message To This BrodCast ! ", Toast.LENGTH_LONG).show();
            }
...
//
    ...
    private void readMesagges(final String myid, final String userid, final String imageurl, String chat_type) {
            ...
            reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        bChat.add(chat);
                        brodcastAdapter = new BrodcastAdapter(MessagePersistanceActivity.this, bChat, imageurl);
       ...
       //     List<Chat> messageListCheck = messagesDAO.getAllConversation(chat_key);

            List<Chat> messageListCheck = null;
            if (messageListCheck != null) {
                mchat = messageListCheck;
            }
            messageAdapter = new MessageAdapter(this, mchat, imageurl);
            ...
            query.addChildEventListener(new ChildEventListener() {
                ...
                public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                    ...
                    if (messagesDAO.isMsgIdExist(msgid)) {
                        Log.d("TAG", "onChildAdded: " + "true" + chat.getMessage() + " " + msgid);
                    } else {

                      //  messagesDAO.insert(chat);
                    }
                }
